...
var _user$project$Types_User$idString = function (_p0) {
	var _p1 = _p0;
	return _p1._0;
};
var _user$project$Types_User$User = F3(
	function (a, b, c) {
		return {id: a, name: b, iconImageUrl: c};
	});
var _user$project$Types_User$UserId = function (a) {
	return {ctor: 'UserId', _0: a};
};

var _user$project$Types_Talk$idString = function (_p0) {
	var _p1 = _p0;
	return _p1._0;
};
var _user$project$Types_Talk$Talk = F4(
	function (a, b, c, d) {
		return {id: a, text: b, createdAt: c, user: d};
	});
var _user$project$Types_Talk$TalkId = function (a) {
	return {ctor: 'TalkId', _0: a};
};

var _user$project$Ports$toResult = function (_p0) {
	var _p1 = _p0;
	var _p2 = _p1.data;
	if (_p2.ctor === 'Just') {
		return _elm_lang$core$Result$Ok(_p2._0);
	} else {
		return _elm_lang$core$Result$Err(_p1.errors);
	}
};
var _user$project$Ports$requestTalkCollectionResource = _elm_lang$core$Native_Platform.outgoingPort(
	'requestTalkCollectionResource',
	function (v) {
		return null;
	});
var _user$project$Ports$receiveTalkCollectionResource = _elm_lang$core$Native_Platform.incomingPort(
												...
												return A2(
													...
													function (createdAt) {
														return _elm_lang$core$Json_Decode$succeed(
															{userId: userId, userName: userName, userIconImageUrl: userIconImageUrl, text: text, talkId: talkId, createdAt: createdAt});
													},
													A2(_elm_lang$core$Json_Decode$field, 'createdAt', _elm_lang$core$Json_Decode$float));
											},
											A2(_elm_lang$core$Json_Decode$field, 'talkId', _elm_lang$core$Json_Decode$int));
									},
									A2(_elm_lang$core$Json_Decode$field, 'text', _elm_lang$core$Json_Decode$string));
							},
							A2(_elm_lang$core$Json_Decode$field, 'userIconImageUrl', _elm_lang$core$Json_Decode$string));
					},
...
var _user$project$Ports$receivePostedTalk = _elm_lang$core$Native_Platform.incomingPort(
	'receivePostedTalk',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (errors) {
		...
		A2(
			...
			'errors',
			_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string))));
var _user$project$Ports$receiveLoginUser = _elm_lang$core$Native_Platform.incomingPort(
	'receiveLoginUser',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (userId) {
			return A2(
				...
				function (name) {
					return A2(
						_elm_lang$core$Json_Decode$andThen,
						function (iconImageUrl) {
							return _elm_lang$core$Json_Decode$succeed(
								{userId: userId, name: name, iconImageUrl: iconImageUrl});
						},
						A2(_elm_lang$core$Json_Decode$field, 'iconImageUrl', _elm_lang$core$Json_Decode$string));
				},
				A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string));
		},
		A2(_elm_lang$core$Json_Decode$field, 'userId', _elm_lang$core$Json_Decode$int)));
var _user$project$Ports$requestPostTalk = _elm_lang$core$Native_Platform.outgoingPort(
	'requestPostTalk',
	function (v) {
		return {text: v.text, userId: v.userId};
	});
var _user$project$Ports$TalkPortDto = F6(
	function (a, b, c, d, e, f) {
		return {userId: a, userName: b, userIconImageUrl: c, text: d, talkId: e, createdAt: f};
	});
var _user$project$Ports$PortTaskResult = F2(
	function (a, b) {
		return {errors: a, data: b};
	});
var _user$project$Ports$LoginUserPortDto = F3(
	function (a, b, c) {
		return {userId: a, name: b, iconImageUrl: c};
	});
var _user$project$Ports$PostTalkDto = F2(
	function (a, b) {
		return {text: a, userId: b};
	});

var _user$project$Styles$deleteButton = _elm_lang$html$Html_Attributes$style(
	{ctor: '[]'});
var _user$project$Styles$editButton = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'margin-right', _1: '8px'},
		_1: {ctor: '[]'}
	});
var _user$project$Styles$buttons = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'float', _1: 'right'},
		_1: {ctor: '[]'}
	});
var _user$project$Styles$talkFooter = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _user$project$Styles$editingMessage = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _user$project$Styles$message = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'margin-left', _1: '72px'},
		_1: {
			ctor: '::',
...
var _user$project$Styles$posterName = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _user$project$Styles$talkRight = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _user$project$Styles$posterImg = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _user$project$Styles$talkLeft = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'padding-left', _1: '12px'},
		_1: {
...
var _user$project$Styles$talk = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'min-height', _1: '120px'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'margin-top', _1: '20px'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'border-bottom', _1: 'solid 1px #c4c4c4'},
				_1: {ctor: '[]'}
			}
		}
	});
var _user$project$Styles$talks = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'margin-top', _1: '20px'},
		_1: {ctor: '[]'}
	});
var _user$project$Styles$postButton = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'margin-top', _1: '8px'},
		_1: {
			...
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'width', _1: '84px'},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'height', _1: '28px'},
					_1: {
...
var _user$project$Styles$formArea = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'margin-top', _1: '8px'},
		_1: {
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'border', _1: 'solid 2px #c4c4c4'},
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Styles$formRight = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'width', _1: '100%'},
		_1: {ctor: '[]'}
	});
var _user$project$Styles$selfImg = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'margin-top', _1: '8px'},
		_1: {
...
var _user$project$Styles$formLeft = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'float', _1: 'left'},
		_1: {
...
var _user$project$Styles$postForm = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'min-height', _1: '120px'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'border-bottom', _1: 'solid 2px #c4c4c4'},
			_1: {ctor: '[]'}
		}
	});
var _user$project$Styles$mainWrap = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _user$project$Types_Page$isViewable = function (page) {
	var _p0 = page;
	if (_p0.ctor === 'Loading') {
		return false;
	} else {
...
var _user$project$Types_Page$isLoading = function (_p1) {
	return !_user$project$Types_Page$isViewable(_p1);
};
var _user$project$Types_Page$FillResourceArg = F3(
	function (a, b, c) {
		return {page: a, resource: b, fill: c};
	});
var _user$project$Types_Page$UpdateModelArg = F3(
	function (a, b, c) {
		return {update: a, msg: b, page: c};
	});
var _user$project$Types_Page$Loading = {ctor: 'Loading'};
var _user$project$Types_Page$toggleLoading = function (page) {
	return _elm_lang$core$Basics$identity(_user$project$Types_Page$Loading);
};
var _user$project$Types_Page$requestResource = F2(
	function (page, cmd) {
		return {
			ctor: '_Tuple2',
			_0: _user$project$Types_Page$toggleLoading(page),
			_1: cmd
		};
	});
var _user$project$Types_Page$Viewable = function (a) {
	return {ctor: 'Viewable', _0: a};
};
var _user$project$Types_Page$fillResource = F3(
	function (page, resource, modelFillResource) {
		var _p2 = page;
		if (_p2.ctor === 'Loading') {
			return _user$project$Types_Page$Viewable(
				A2(modelFillResource, resource, _elm_lang$core$Maybe$Nothing));
		} else {
			return _user$project$Types_Page$Viewable(
				A2(
					modelFillResource,
...
var _user$project$Types_Page$fillResource_ = function (arg) {
	return A3(_user$project$Types_Page$fillResource, arg.page, arg.resource, arg.fill);
};
var _user$project$Types_Page$updateModel = F3(
	function (update, msg, page) {
		...
		if (_p3.ctor === 'Loading') {
			...
			return A2(
				...
				_user$project$Types_Page$Viewable,
				A2(update, msg, _p3._0));
		}
	});
var _user$project$Types_Page$updateModel_ = function (arg) {
	return A3(_user$project$Types_Page$updateModel, arg.update, arg.msg, arg.page);
};

var _user$project$Model_TalkCollection$createPostTalkDto = F2(
	function (user, postForm) {
		return {
			text: postForm.talkText,
			userId: _user$project$Types_User$idString(user.id)
		};
	});
var _user$project$Model_TalkCollection$updateTalkText = F2(
	function (text, form) {
		return {talkText: text};
	});
var _user$project$Model_TalkCollection$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'UpdatePostTalkText':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							postForm: A2(_user$project$Model_TalkCollection$updateTalkText, _p0._0, model.postForm)
						}),
					{ctor: '[]'});
			case 'PostTalk':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{runningPostTalk: true}),
					{
						ctor: '::',
						_0: _user$project$Ports$requestPostTalk(
							A2(_user$project$Model_TalkCollection$createPostTalkDto, _p0._0, model.postForm)),
						_1: {ctor: '[]'}
					});
			default:
				var _p1 = _p0._0;
...
var _user$project$Model_TalkCollection$isValidPortForm = function (form) {
	return _elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$String$length(form.talkText),
		0) > 0;
};
var _user$project$Model_TalkCollection$PostForm = function (a) {
	return {talkText: a};
};
var _user$project$Model_TalkCollection$initialPostForm = _user$project$Model_TalkCollection$PostForm('');
var _user$project$Model_TalkCollection$Resource = function (a) {
	return {talks: a};
};
var _user$project$Model_TalkCollection$Model = F3(
	function (a, b, c) {
		return {talks: a, postForm: b, runningPostTalk: c};
	});
var _user$project$Model_TalkCollection$fillResource = F2(
	function (resource, maybeModel) {
		var _p2 = maybeModel;
		if (_p2.ctor === 'Just') {
			return _elm_lang$core$Native_Utils.update(
				_p2._0,
				{talks: resource.talks});
		} else {
			return A3(_user$project$Model_TalkCollection$Model, resource.talks, _user$project$Model_TalkCollection$initialPostForm, false);
		}
	});
var _user$project$Model_TalkCollection$FinishPostTalk = function (a) {
	return {ctor: 'FinishPostTalk', _0: a};
};
var _user$project$Model_TalkCollection$PostTalk = function (a) {
	return {ctor: 'PostTalk', _0: a};
};
var _user$project$Model_TalkCollection$UpdatePostTalkText = function (a) {
	return {ctor: 'UpdatePostTalkText', _0: a};
};

var _user$project$Routes$toUrlStr = function (route) {
	var _p0 = route;
	if (_p0.ctor === 'TalkCollection') {
		return '/';
	} else {
		return 'notfound';
	}
};
var _user$project$Routes$toHashUrl = function (_p1) {
	return A2(
		F2(
			function (x, y) {
		...
		'#',
		_user$project$Routes$toUrlStr(_p1));
};
var _user$project$Routes$NotFound = {ctor: 'NotFound'};
var _user$project$Routes$TalkCollection = {ctor: 'TalkCollection'};
var _user$project$Routes$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Routes$TalkCollection, _evancz$url_parser$UrlParser$top),
		_1: {ctor: '[]'}
	});
var _user$project$Routes$fromLocation = function (location) {
	...
	if (_p2.ctor === 'Just') {
		...
		return _user$project$Routes$NotFound;
	}
};

var _user$project$Model$mapCmdTuple = function (_p0) {
	var _p1 = _p0;
	return function (_p2) {
		return A2(
			_elm_lang$core$Tuple$mapSecond,
			_elm_lang$core$Platform_Cmd$map(_p1._1),
			A2(_elm_lang$core$Tuple$mapFirst, _p1._0, _p2));
	};
};
var _user$project$Model$setRoute = F2(
	function (route, model) {
		var updatedRouteModel = _elm_lang$core$Native_Utils.update(
			model,
			{currentRoute: route});
		var _p3 = route;
		if (_p3.ctor === 'TalkCollection') {
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				_elm_lang$core$Native_Utils.update(
					updatedRouteModel,
					{talkCollectionPage: _user$project$Types_Page$Loading}),
				{
					ctor: '::',
					_0: _user$project$Ports$requestTalkCollectionResource(
						{ctor: '_Tuple0'}),
					_1: {ctor: '[]'}
				});
		} else {
...
var _user$project$Model$updateTalkCollectionPage = F2(
	function (page, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{talkCollectionPage: page});
	});
var _user$project$Model$Model = F4(
	function (a, b, c, d) {
		return {talkCollectionPage: a, loginUser: b, currentRoute: c, errors: d};
	});
var _user$project$Model$ReceiveErrors = function (a) {
	return {ctor: 'ReceiveErrors', _0: a};
};
var _user$project$Model$SetRoute = function (a) {
	return {ctor: 'SetRoute', _0: a};
};
var _user$project$Model$ReceiveTalkCollectionResource = function (a) {
	return {ctor: 'ReceiveTalkCollectionResource', _0: a};
};
var _user$project$Model$TalkCollectionMsg = function (a) {
	return {ctor: 'TalkCollectionMsg', _0: a};
};
		...
		switch (_p4.ctor) {
			case 'Logout':
				return A2(
					...
					{ctor: '[]'});
			case 'SetRoute':
				return A2(_user$project$Model$setRoute, _p4._0, model);
			case 'TalkCollectionMsg':
				return A2(
					_user$project$Model$mapCmdTuple,
					{
						ctor: '_Tuple2',
						_0: A2(_elm_lang$core$Basics$flip, _user$project$Model$updateTalkCollectionPage, model),
						_1: _user$project$Model$TalkCollectionMsg
					},
					_user$project$Types_Page$updateModel_(
						{update: _user$project$Model_TalkCollection$update, msg: _p4._0, page: model.talkCollectionPage}));
			case 'ReceiveTalkCollectionResource':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							talkCollectionPage: _user$project$Types_Page$fillResource_(
								{page: model.talkCollectionPage, resource: _p4._0, fill: _user$project$Model_TalkCollection$fillResource})
						}),
					{ctor: '[]'});
			default:
				return A2(
...
var _user$project$View$postTalkForm = F2(
	function (user, postForm) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _user$project$Styles$postForm,
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Styles$formLeft,
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$Styles$selfImg,
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$src(user.iconImageUrl),
									_1: {ctor: '[]'}
								}
							},
							{ctor: '[]'}),
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Styles$formRight,
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _user$project$Styles$formArea,
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(
											function (_p0) {
												return _user$project$Model$TalkCollectionMsg(
													_user$project$Model_TalkCollection$UpdatePostTalkText(_p0));
											}),
										_1: {ctor: '[]'}
									}
								},
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _user$project$Styles$postButton,
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$Model$TalkCollectionMsg(
													_user$project$Model_TalkCollection$PostTalk(user))),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$disabled(
													!_user$project$Model_TalkCollection$isValidPortForm(postForm)),
												_1: {ctor: '[]'}
											}
										}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('投稿！'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
...
var _user$project$View$loginUserView = function (_p1) {
	var _p2 = _p1;
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: _elm_lang$html$Html$text(
				A2(_elm_lang$core$Basics_ops['++'], 'LOGIN USER: ', _p2.loginUser.name)),
			_1: {ctor: '[]'}
		});
};
var _user$project$View$monthToInt = function (month) {
	var _p3 = month;
	switch (_p3.ctor) {
		case 'Jan':
			return 1;
...
var _user$project$View$viewEditingTalk = function (_p4) {
	var _p5 = _p4;
	var _p6 = _p5.user;
	return A2(
		_elm_lang$html$Html$div,
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Styles$talkLeft,
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Styles$posterImg,
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$src(_p6.iconImageUrl),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Styles$talkRight,
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$Styles$posterName,
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _user$project$Styles$editingMessage,
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(_p5.text),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _user$project$Styles$talkFooter,
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(
											_user$project$View$dateToString(_p5.createdAt)),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html$div,
												...
												},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _user$project$Styles$editButton,
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('完了'),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: A2(
															...
															{
																ctor: '::',
																_0: _user$project$Styles$deleteButton,
																_1: {ctor: '[]'}
															},
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('削除'),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}
...
var _user$project$View$talkView = function (talk) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
				...
				},
				{
					...
					_0: A2(
						_elm_lang$html$Html$img,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$src(talk.user.iconImageUrl),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(talk.user.name),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _user$project$Styles$message,
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(talk.text),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(
											_user$project$View$dateToString(talk.createdAt)),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
...
var _user$project$View$talkViewList = F2(
	function (user, model) {
		return A2(_elm_lang$core$List$map, _user$project$View$talkView, model.talks);
	});
var _user$project$View$talkCollectionPageView = F2(
	function (user, talkCollectionPage) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _user$project$Styles$mainWrap,
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$Basics_ops['++'],
				{
					ctor: '::',
					_0: A2(_user$project$View$postTalkForm, user, talkCollectionPage.postForm),
					_1: {ctor: '[]'}
				},
				A2(_user$project$View$talkViewList, user, talkCollectionPage)));
	});
var _user$project$View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$View$loginUserView(model),
			_1: {
				ctor: '::',
				_0: function () {
					var _p7 = model.talkCollectionPage;
					if (_p7.ctor === 'Loading') {
						return _elm_lang$html$Html$text('loading');
					} else {
						return A2(_user$project$View$talkCollectionPageView, model.loginUser, _p7._0);
					}
				}(),
				_1: {ctor: '[]'}
			}
...
var _user$project$Main$init = F2(
	function (jsValue, location) {
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			A2(
				_user$project$Model$initialModel,
				{
					id: _user$project$Types_User$UserId('100'),
					name: 'SUZUKI',
					iconImageUrl: 'https://grapee.jp/wp-content/uploads/32187_main2.jpg'
				},
				_user$project$Routes$fromLocation(location)),
			{ctor: '[]'});
	});
var _user$project$Main$getError = function (result) {
	var _p0 = result;
	if (_p0.ctor === 'Ok') {
		return _elm_lang$core$Maybe$Nothing;
	} else {
...
var _user$project$Main$appSubscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Ports$receivePostedTalk(
				function (_p1) {
					return _user$project$Model$ReceiveErrors(
						A2(
							_elm_lang$core$Maybe$withDefault,
							{ctor: '[]'},
							_user$project$Main$getError(
								_user$project$Ports$toResult(_p1))));
				}),
			_1: {ctor: '[]'}
		});
};
var _user$project$Main$loginUserDtoToModel = function (dto) {
	return {
		id: _user$project$Types_User$UserId(
			_elm_lang$core$Basics$toString(dto.userId)),
		name: dto.name,
		iconImageUrl: dto.iconImageUrl
	};
};
var _user$project$Main$talkDtoToModel = function (dto) {
	var user = {
		id: _user$project$Types_User$UserId(
			_elm_lang$core$Basics$toString(dto.userId)),
		name: dto.userName,
	...
	return {
		user: user,
		id: _user$project$Types_Talk$TalkId(
			_elm_lang$core$Basics$toString(dto.talkId)),
		text: dto.text,
		createdAt: _elm_lang$core$Date$fromTime(dto.createdAt)
	};
};
var _user$project$Main$pageSubscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Ports$receiveTalkCollectionResource(
				function (_p2) {
					return _user$project$Model$ReceiveTalkCollectionResource(
						_user$project$Model_TalkCollection$Resource(
							A2(_elm_lang$core$List$map, _user$project$Main$talkDtoToModel, _p2)));
				}),
			_1: {
				ctor: '::',
				_0: _user$project$Ports$receivePostedTalk(
					function (_p3) {
						return _user$project$Model$TalkCollectionMsg(
							_user$project$Model_TalkCollection$FinishPostTalk(
								A2(
									_elm_lang$core$Result$map,
									_user$project$Main$talkDtoToModel,
									_user$project$Ports$toResult(_p3))));
					}),
				_1: {ctor: '[]'}
			}
		});
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Main$pageSubscriptions(model),
			_1: {
				ctor: '::',
				_0: _user$project$Main$appSubscriptions(model),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$main = A2(
	...
	function (_p4) {
		return _user$project$Model$SetRoute(
			_user$project$Routes$fromLocation(_p4));
	},
	{init: _user$project$Main$init, view: _user$project$View$view, update: _user$project$Model$update, subscriptions: _user$project$Main$subscriptions})(_elm_lang$core$Json_Decode$value);

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Types.Talk.Id":{"args":[],"tags":{"TalkId":["String"]}},"Types.User.Id":{"args":[],"tags":{"UserId":["String"]}},"Model.TalkCollection.Msg":{"args":[],"tags":{"PostTalk":["Types.User.User"],"UpdatePostTalkText":["String"],"FinishPostTalk":["Result.Result (List String) Types.Talk.Talk"]}},"Model.Msg":{"args":[],"tags":{"Logout":[],"TalkCollectionMsg":["Model.TalkCollection.Msg"],"SetRoute":["Routes.Route"],"ReceiveTalkCollectionResource":["Model.TalkCollection.Resource"],"ReceiveErrors":["List String"]}},"Date.Date":{"args":[],"tags":{"Date":[]}},"Routes.Route":{"args":[],"tags":{"TalkCollection":[],"NotFound":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Types.Talk.Talk":{"args":[],"type":"{ id : Types.Talk.Id , text : String , createdAt : Date.Date , user : Types.User.User }"},"Model.TalkCollection.Resource":{"args":[],"type":"{ talks : List Types.Talk.Talk }"},"Types.User.User":{"args":[],"type":"{ id : Types.User.Id, name : String, iconImageUrl : String }"}},"message":"Model.Msg"},"versions":{"elm":"0.18.0"}});
}
